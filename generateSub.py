...
# file = '/output/reSubData.test.dat'
file = '/output/reSubData.dat'
path = os.getcwd() + file
f = open(path, 'r')
...
while True:
	...
	layer2.append(nonlin(np.dot(layer1, syn1)) + l2_bias)

f.close()

file = '/output/submission'
path = os.getcwd() + file
f = open(path, 'a')
